...
def wave5_method_catalog() -> dict[str, dict[str, Any]]:
    ...
    enchant_tiers = {
        ...
        "diamond": (57, (("Cosmic rune", 1), ("Earth rune", 10)), "Earth-rune supplying staff", {"ring": "Ring of life", "necklace": "Phoenix necklace", "bracelet": "Forinthry bracelet(5)", "amulet": "Amulet of power"}),
    ...
    standard = (
        ("varrock", "Varrock teleport", 25, (("Law rune", 1), ("Air rune", 3), ("Fire rune", 1)), "Oak lectern", 40),
        ("lumbridge", "Lumbridge teleport", 31, (("Law rune", 1), ("Air rune", 3), ("Earth rune", 1)), "Eagle lectern", 47),
        ("falador", "Falador teleport", 37, (("Law rune", 1), ("Air rune", 3), ("Water rune", 1)), "Eagle lectern", 47),
        ("house", "Teleport to house", 40, (("Law rune", 1), ("Air rune", 1), ("Earth rune", 1)), "Mahogany eagle lectern", 67),
        ("camelot", "Camelot teleport", 45, (("Law rune", 1), ("Air rune", 5)), "Teak eagle lectern", 57),
        ("kourend_castle", "Kourend castle teleport", 48, (("Law rune", 2), ("Water rune", 1), ("Fire rune", 1)), "Teak eagle lectern", 57),
        ("ardougne", "Ardougne teleport", 51, (("Law rune", 2), ("Water rune", 2)), "Teak eagle lectern", 57),
        ("civitas_illa_fortis", "Civitas illa fortis teleport", 54, (("Law rune", 2), ("Earth rune", 1), ("Fire rune", 1)), "Mahogany eagle lectern", 67),
        ("watchtower", "Watchtower teleport", 58, (("Law rune", 2), ("Earth rune", 2)), "Mahogany eagle lectern", 67),
    ...
    for key, product, level, runes, lectern, construction in standard:
        add(f"make_teleport_tablet_standard_{key}", f"Make {product} tablets", "bankstanding/magic", [ge("Soft clay"), *[ge(n, q) for n, q in runes]], [out(product)], 1200, 2.4, {"members": True, "magic": level, "construction": construction, "equipment": [lectern]}, "Standard spellbook teleport tablet. Four-tick creation plus banking overhead.", "https://oldschool.runescape.wiki/w/Magic_tablet", theoretical_cycles_per_hour=1500, workflow={"process_seconds": 2.4, "bank_seconds": 0.6, "travel_seconds": 0}, variants=[{"id": "minimum_lectern", "label": lectern, "overrides": {}}, {"id": "marble_lectern", "label": "Marble lectern", "overrides": {"requirements": {"members": True, "magic": level, "construction": 77, "equipment": ["Marble lectern"]}}}], method_types=["bankstanding", "variants"])

    ancient = (
        ("paddewwa", "Paddewwa teleport", 54, (("Law rune", 2), ("Air rune", 1), ("Fire rune", 1))), ("senntisten", "Senntisten teleport", 60, (("Law rune", 2), ("Soul rune", 1))), ("kharyrll", "Kharyrll teleport", 66, (("Law rune", 2), ("Blood rune", 1))), ("lassar", "Lassar teleport", 72, (("Law rune", 2), ("Water rune", 4))), ("dareeyak", "Dareeyak teleport", 78, (("Law rune", 2), ("Air rune", 2), ("Fire rune", 3))), ("carrallanger", "Carrallanger teleport", 84, (("Law rune", 2), ("Soul rune", 2))), ("annakarl", "Annakarl teleport", 90, (("Law rune", 2), ("Blood rune", 2))), ("ghorrock", "Ghorrock teleport", 96, (("Law rune", 2), ("Water rune", 8))),
    )
    lunar = (
        ("moonclan", "Moonclan teleport", 69, (("Law rune", 1), ("Astral rune", 2), ("Earth rune", 2))), ("ourania", "Ourania teleport", 71, (("Law rune", 1), ("Astral rune", 2), ("Earth rune", 6))), ("waterbirth", "Waterbirth teleport", 72, (("Law rune", 1), ("Astral rune", 2), ("Water rune", 1))), ("barbarian", "Barbarian teleport", 75, (("Law rune", 2), ("Astral rune", 2), ("Fire rune", 3))), ("khazard", "Khazard teleport", 78, (("Law rune", 2), ("Astral rune", 2), ("Water rune", 4))), ("fishing_guild", "Fishing guild teleport", 85, (("Law rune", 3), ("Astral rune", 3), ("Water rune", 10))), ("catherby", "Catherby teleport", 87, (("Law rune", 3), ("Astral rune", 3), ("Water rune", 10))), ("ice_plateau", "Ice plateau teleport", 89, (("Law rune", 3), ("Astral rune", 3), ("Water rune", 8))),
    )
    for book, rows, equipment, quest in (("ancient", ancient, "Ancient Pyramid lectern", "Desert Treasure I"), ("lunar", lunar, "Lunar Isle ceremonial building lectern", "Lunar Diplomacy")):
        for key, product, level, runes in rows:
            add(f"make_teleport_tablet_{book}_{key}", f"Make {product} tablets", "bankstanding/magic", [ge("Soft clay"), *[ge(n, q) for n, q in runes]], [out(product)], 1200, 2.4, {"members": True, "magic": level, "quests": [quest], "equipment": [equipment]}, f"{book.title()} teleport tablet with its dedicated lectern requirement.", "https://oldschool.runescape.wiki/w/Magic_tablet", theoretical_cycles_per_hour=1500, workflow={"process_seconds": 2.4, "bank_seconds": 0.6, "travel_seconds": 0}, method_types=["bankstanding"])

    arceuus = (("arceuus_library", "Arceuus library teleport", 6), ("draynor_manor", "Draynor manor teleport", 17), ("battlefront", "Battlefront teleport", 23), ("mind_altar", "Mind altar teleport", 28), ("salve_graveyard", "Salve graveyard teleport", 40), ("fenkenstrain", "Fenkenstrain's castle teleport", 48), ("west_ardougne", "West ardougne teleport", 61), ("harmony_island", "Harmony island teleport", 65), ("cemetery", "Cemetery teleport", 71), ("barrows", "Barrows teleport", 83), ("ape_atoll", "Ape atoll teleport", 90))
    for key, product, level in arceuus:
        add(f"make_teleport_tablet_arceuus_{key}", f"Make {product} tablets", "bankstanding/magic", [], [out(product)], 1200, 2.4, {"members": True, "magic": level, "mining": 38, "equipment": ["Arceuus lectern"], "supplies": ["Self-supplied dark essence block and spell runes"]}, "Arceuus tablets consume an untradeable dark essence block. This catalogue entry intentionally reports market revenue only until an integrated essence/time model is available.", "https://oldschool.runescape.wiki/w/Magic_tablet", theoretical_cycles_per_hour=1500, model={"unpricedInputs": ["Dark essence block", "Spell runes pending recipe audit"]}, method_types=["bankstanding"])
    ...
    for key, source, product in (("crushed_nests", "Bird nest", "Crushed nest"), ("goat_horn_dust", "Desert goat horn", "Goat horn dust"), ("kebbit_teeth_dust", "Kebbit teeth", "Kebbit teeth dust")):
